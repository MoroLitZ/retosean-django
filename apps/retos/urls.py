...
urlpatterns = [
    ...
    path('integraciones/<int:pk>/enviar-revision/', views.enviar_integracion_revision, name='enviar_integracion_revision'),
    path('integracion/<int:pk>/equipo/crear/', views.crear_equipo_academico, name='crear_equipo_academico'),
    path('equipo/<int:pk>/editar/', views.editar_equipo_academico, name='editar_equipo_academico'),
    path('equipo/<int:pk>/eliminar/', views.eliminar_equipo_academico, name='eliminar_equipo_academico'),
    path('integracion/<int:pk>/sesion/registrar/', views.registrar_sesion_academica, name='registrar_sesion_academica'),
    ...
    path('admin/vinculaciones/', views.admin_vinculaciones, name='admin_vinculaciones'),
    path('admin/vinculaciones/<int:pk>/revisar/', views.admin_revisar_vinculacion, name='admin_revisar_vinculacion'),
    ...
    path('mis-equipos/', views.mis_equipos_estudiante, name='mis_equipos_estudiante'),
]
